    ...
    function renderFiles() {
      ...
      if (tableBody) {
        ...
        currentFiles.forEach(f => {
          ...
          tr.innerHTML = `
            ...
            <td style="padding:14px 16px;border-bottom:1px solid #f1f5f9;text-align:right;">
              <div style="display:flex;align-items:center;justify-content:flex-end;gap:6px;">
                <button type="button" class="btn btn-secondary btn-sm btn-download-file" title="Download">Download</button>
          ...
          tr.querySelector('.btn-download-file').onclick = () => { window.location.href = `/api/files/${encodeURIComponent(f.id)}/download`; };
        ...
        currentFiles.forEach(f => {
          ...
          card.innerHTML = `
            ...
            <div style="display:flex;align-items:center;justify-content:flex-end;gap:8px;border-top:1px solid #f8fafc;padding-top:8px;">
              <button type="button" class="btn btn-secondary btn-sm btn-mobile-download">Download</button>
          ...
          `;
          card.querySelector('.btn-mobile-download').onclick = () => { window.location.href = `/api/files/${encodeURIComponent(f.id)}/download`; };
